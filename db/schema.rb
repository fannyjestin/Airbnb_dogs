...
ActiveRecord::Schema.define(version: 2019_10_24_135728) do
  ...
  create_table "dogsstrolls", force: :cascade do |t|
    t.integer "stroll_id"
    t.integer "dog_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["dog_id"], name: "index_dogsstrolls_on_dog_id"
    t.index ["stroll_id"], name: "index_dogsstrolls_on_stroll_id"
  end
